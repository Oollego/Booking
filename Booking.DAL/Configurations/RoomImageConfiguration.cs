...
namespace Booking.DAL.Configurations
{
    internal class RoomImageConfiguration: IEntityTypeConfiguration<RoomImage>
    {
            ...
            builder.HasData(new List<RoomImage>
        {
            ...
            new RoomImage { Id = 34, ImageName = "158244608.jpg", RoomId = 20 },
            new RoomImage { Id = 35, ImageName = "216077342.jpg", RoomId = 20 },
            new RoomImage { Id = 36, ImageName = "158227246.jpg", RoomId = 20 },

            // Photos for Historic Suite (Id = 21)
            new RoomImage { Id = 37, ImageName = "581982230.jpg", RoomId = 21 },
            new RoomImage { Id = 38, ImageName = "521690205.jpg", RoomId = 21 },
            new RoomImage { Id = 39, ImageName = "65822867.jpg", RoomId = 21 },

            // Photos for City View Room (Id = 22)
            new RoomImage { Id = 40, ImageName = "317277974.jpg", RoomId = 22 },
            new RoomImage { Id = 41, ImageName = "520815355.jpg", RoomId = 22 },
            new RoomImage { Id = 42, ImageName = "182754259.jpg", RoomId = 22 },

            // Photos for Palace Suite (Id = 23)
            new RoomImage { Id = 43, ImageName = "81856512.jpg", RoomId = 23 },
            new RoomImage { Id = 44, ImageName = "182753071.jpg", RoomId = 23 },
            new RoomImage { Id = 45, ImageName = "520815372.jpg", RoomId = 23 },

            // Photos for Boutique Room (Id = 24)
            new RoomImage { Id = 46, ImageName = "341936743.jpg", RoomId = 24 },
            new RoomImage { Id = 47, ImageName = "399559598.jpg", RoomId = 24 },
            new RoomImage { Id = 48, ImageName = "374514783.jpg", RoomId = 24 },

            // Photos for Gran Via Suite (Id = 25)
            new RoomImage { Id = 49, ImageName = "341938138.jpg", RoomId = 25 },
            new RoomImage { Id = 50, ImageName = "595168488.jpg", RoomId = 25 },
            new RoomImage { Id = 51, ImageName = "341938123.jpg", RoomId = 25 },

            // Photos for Lakeview Room (Id = 26)
            new RoomImage { Id = 52, ImageName = "341938129.jpg", RoomId = 26 },
            new RoomImage { Id = 53, ImageName = "353666305.jpg", RoomId = 26 },
            new RoomImage { Id = 54, ImageName = "374514791.jpg", RoomId = 26 },

            // Photos for Lakefront Suite (Id = 27)
            new RoomImage { Id = 55, ImageName = "438054500.jpg", RoomId = 27 },
            new RoomImage { Id = 56, ImageName = "438054487.jpg", RoomId = 27 },
            new RoomImage { Id = 57, ImageName = "438054499.jpg", RoomId = 27 },

            // Photos for Ocean Breeze Room (Id = 28)
            new RoomImage { Id = 58, ImageName = "415932921.jpg", RoomId = 28 },
            new RoomImage { Id = 59, ImageName = "438054489.jpg", RoomId = 28 },
            new RoomImage { Id = 60, ImageName = "250659784.jpg", RoomId = 28 },

            // Photos for Business Suite (Id = 29)
            new RoomImage { Id = 61, ImageName = "415932912.jpg", RoomId = 29 },
            new RoomImage { Id = 62, ImageName = "438058113.jpg", RoomId = 29 },
            new RoomImage { Id = 63, ImageName = "378321159.jpg", RoomId = 29 },

            // Photos for Countryside Room (Id = 30)
            new RoomImage { Id = 64, ImageName = "370611422.jpg", RoomId = 30 },
            new RoomImage { Id = 65, ImageName = "370611499.jpg", RoomId = 30 },
            new RoomImage { Id = 66, ImageName = "370611483.jpg", RoomId = 30 },

            // Photos for Rustic Suite (Id = 31)
            new RoomImage { Id = 67, ImageName = "370611385.jpg", RoomId = 31 },
            new RoomImage { Id = 68, ImageName = "370611395.jpg", RoomId = 31 },
            new RoomImage { Id = 69, ImageName = "370611454.jpg", RoomId = 31 }
        });
        }
    }
}
