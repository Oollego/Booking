...
namespace Booking.DAL.Configurations
{
    internal class TopicConfiguration : IEntityTypeConfiguration<Topic>
    {
        public void Configure(EntityTypeBuilder<Topic> builder)
        {
            ...
            builder.Property(x => x.TopicImage).HasMaxLength(254).HasDefaultValue("");
            ...
            builder.HasData( new List<Topic>
            {
                new Topic()
                {
                    ...
                    TopicImage = "2b03bec6abec3c61cab333df168d2505.jpg"
                },
                new Topic()
                {
                    Id = 2,
                    ...
                    TopicImage = "96553d3f240dce709b128b5c98cfba21.jpg"
                },
                new Topic()
                {
                    Id = 3,
                    ...
                    TopicImage = "d475159dac94c27664a92ebb2db692e5.jpg"
                },
                new Topic()
                {
                    Id = 4,
                    ...
                    TopicImage = "2ddd638db07764dcd5c0d0918f1e5b72.jpg"
                }
            });
        }
    }
